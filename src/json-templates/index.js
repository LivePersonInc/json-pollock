...
const allTemplates = [
  ...
  {
    types: ['web', 'line', 'abc', 'fb', 'rcs'],
    name: 'FB Carousel with Complex Cards FB Carousel with Complex Cards FB Carousel with Complex Cards FB Carousel with Complex Cards FB Carousel with Complex Cards FB Carousel with Complex Cards FB Carousel with Complex Cards',
    description: 'A Rich Content Message containing a Carousel with one vertical and one horizontal card. Each card contains a Button, Image, Map and Text component inside. Adjusted to run in FB. (s. comment for adjustments)',
    content: require('./rcCarouselComplex.json'),
  },
  {
