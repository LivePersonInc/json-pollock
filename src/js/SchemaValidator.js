...
import customSettingsSchema from './schema/customSettings.json';
import customContainerSettingsSchema from './schema/customContainerSettings.json';
...
import separatorSchema from './schema/separator.json';
...
export default class SchemaValidator {
  ...
  constructor() {
    ...
    ajv.addSchema(customSettingsSchema, 'customSettings.json');
    ajv.addSchema(customContainerSettingsSchema, 'customContainerSettings.json');
    ajv.addSchema(separatorSchema, 'separator.json');
  ...
  /**
   * @param {*} json
   * @return {{ valid: boolean, errors?: Ajv.ErrorObject[] | undefined }}
   */
  validate(json) {
