...
The **Json-Pollock** package renders live DOM elements out of JSON according to the [Structured Messaging Templates specification](/guide/introduction)

## Installation

<PackageManagerTabs command="install json-pollock" />
